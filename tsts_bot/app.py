...
- MULTI-SETUP DETECTION: A single chart can contain MULTIPLE setups, especially on the 5m. Each V-shape in the histogram (each pink/blue divergence) is a separate LOGO trade opportunity. Scan the ENTIRE chart history, not just the rightmost candle. Report all setups found with their approximate entry points.
