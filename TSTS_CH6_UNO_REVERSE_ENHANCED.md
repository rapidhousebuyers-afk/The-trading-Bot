# CHAPTER 6: UNO REVERSE (KEITH BOT) — ENHANCED COURSE NOTES
## "The Only Trade You'll Ever Need" / "The Oreo Cookie Trade"
### Compiled from Course Build + 3 Video Transcripts

---

## DEFINITION: UNO REVERSE STEROID

**Uno Reverse (Keith Bot)** — A semi-automatic robot indicator (Pine Script on TradingView) that monitors five major US indices across sequential timeframes, reading whether price is above or below the system's Blue Line (an EMA). Named after the Uno reverse card — it detects when a market reversal is occurring from bearish red to bullish green, or vice versa. Named in honor of the great late Keith Palmer, the coder who built it. Kevin describes it as "a big sniper rifle on steroids" — it reads the Sniper indicator data and condenses all the information into one dashboard, then sends an automatic signal when the setup triggers.

**Also known as:**
- "The Only Trade You'll Ever Need" — because if this is the only trade type you ever take, you can become a consistently profitable trader
- "The Oreo Cookie Trade" / "Oreo Sandwich" — due to its signature visual pattern on the dashboard
- "The Overnight Reversal Trade" — because it's designed for catching reversals that happen overnight after the market moves hard in one direction all day
...
You can see the entire market picture across all timeframes and all symbols at a glance.
...
During a reversal, timeframes flip from red to green **in ascending order**. Each flip confirms the reversal is gaining strength. It's a domino effect. If the 1s, 5s, and 10s have flipped, you **know** the 15s is next. This predictability is what allows you to send signals before the move completes.
...
## "THE ONLY TRADE YOU'LL EVER NEED" — THE OVERNIGHT REVERSAL
...
- This happens **2-5 times per week**.
...
- Wait for the next timeframes in order to flip: 5s → 10s → 15s
...
4. **After training, buy the Sniper** ($250/month) — this includes:
   - The **Sniper** indicator (pink, blue, purple lines)
...
These two indicators work hand-in-hand with the Keith Bot:
...
This applies to all symbols:
- **Gold:** Only buys. Ever. "Buy, buy, buy, buy, buy."
- **Bitcoin:** Daily/weekly buy stop — only play the buys
- **XRP/XLM:** Follow the higher timeframe flow

---

## LIVE EXAMPLE (3/13/25)
...
Robot sends automatic signals when the setup triggers on the fourth timeframe.
...
*Compiled from:*
- *TSTS Final Course Build — Chapter 6*
- *"The Safest Trade in the World — The Uno Overnight Reversal — Live Demo Trading 3/13/25"*
- *"Mental Side of Trading — The Uno Reverse Indicator & Other Stuff — Great Training Video"*
- *"This is the 1 Trade You All Need — Here Is How to Do It! The Overnight Reversal Trade 2/6/26"*
